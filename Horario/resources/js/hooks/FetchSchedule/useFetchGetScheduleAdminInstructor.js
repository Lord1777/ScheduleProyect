...
export const useFetchGetScheduleAdminInstructor = (route, idUsuario, idHorario, idTrimestre, setHorasAsignadasValue) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`${API_URL}${route}/${idUsuario}/${idHorario}/${idTrimestre}`, {
                    method: "GET",
                    headers: {
        ...
        fetchData();
    }, [idTrimestre, setHorasAsignadasValue])
