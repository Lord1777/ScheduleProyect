          ...
          <div className='container_form_add'>
            <form method='POST'>
              <div className='grid-column'>
                <input type='number' name='NFicha' value='2560354' />

                <input type='number' name='Duracion' value='3000' />

                <input type='text' name='Programa' value='Análisis y desarrollo de software' />
